...
public class MultipleDbContextDemoDbMigrationService : ITransientDependency
{
    public ILogger<MultipleDbContextDemoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IMultipleDbContextDemoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public MultipleDbContextDemoDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IMultipleDbContextDemoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<MultipleDbContextDemoDbMigrationService>.Instance;
    }
